...
for var in "fluttershy" "zork" "bigzork" "turtle" "helltrain"; do
	./corewar ressources/zaz_champ/$var.cor ressources/zaz_champ/$var.cor -v16 > /tmp/v16me
	./ressources/corewar_goinfre ressources/zaz_champ/$var.cor ressources/zaz_champ/$var.cor -v 16 > /tmp/v16you
	diff /tmp/v16me /tmp/v16you > /tmp/diff
	diff=$(wc -l < /tmp/diff)
	if [ $diff != 0 ]
	then
